                                      ...
                                      <a href="{{route('softwareRequest')}}">
                                          <div class="card-flyer">
                                              <div class="text-box" data-toggle="tooltip" data-placement="top" title="ipsum dolor sit amet consectetur adipisicing elit. Amet ipsa quia similique sed! Dolorum, officiis .">
                                                  <div class="image-box">
                                                      <img src="/images/admin_images/software_300.png" alt="" />
                                                  </div>
                                  ...
                                  <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 h-100">
                                    <a href="{{route('hardwareRequest')}}">
                                      <div class="card-flyer">
                                        <div class="text-box" data-toggle="tooltip" data-placement="top" title="ipsum dolor sit amet consectetur adipisicing elit. Amet ipsa quia similique sed! Dolorum, officiis .">
                                          <div class="image-box">
                                            <img src="/images/admin_images/puzzle_300.png" alt="" />
                                          </div>
                                          <div class="text-container">                                    
                                  ...
                                  <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 h-100">
                                    <a href="{{route('pc_problems')}}">
                                      <div class="card-flyer">
                                        <div class="text-box" data-toggle="tooltip" data-placement="top" title="ipsum dolor sit amet consectetur adipisicing elit. Amet ipsa quia similique sed! Dolorum, officiis .">
                                          <div class="image-box">
                                              <img src="/images/admin_images/course_300.png" alt="" />
                                          </div>
                                          <div class="text-container">
                                              <h6>PC-Probleme</h6>
                                          </div>
                                  ...
                                  <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 h-100">
                                    <a href="{{route('other')}}">
                                      <div class="card-flyer">
                                        <div class="text-box" data-toggle="tooltip" data-placement="top" title="ipsum dolor sit amet consectetur adipisicing elit. Amet ipsa quia similique sed! Dolorum, officiis .">
                                          <div class="image-box">
                                              <img src="/images/admin_images/Question_300.png" alt="" />
                                          </div>
                                          <div class="text-container">
                                              <h6>Sonstiges...</h6>
                                          </div>
