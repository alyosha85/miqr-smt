...
<div class="card mx-auto" style="width: 80%">
  <div class="card-header"><h2>Berechtigungen</h2></div>
  <div class="card-body">
    <div class="row">
      <div class="col-md-12">
  ...
  <div class="card-footer text-right">
    <button type="button" class="btn btn-success">Ändern</button>
    <button type="button" class="btn btn-danger">Verwerfen</button>
  </div>
</div>
