    ...
    <div class="media-body">
        ...
        <div>
            @can('reply-to-comment', $comment)
                <span data-toggle="modal" data-target="#reply-modal-{{ $comment->getKey() }}"><button data-toggle="tooltip" data-placement="right" title="Antwort" class="btn btn-sm btn-link text-uppercase"><i class="fas fa-reply fa-lg"></i></button></span>
            @endcan
