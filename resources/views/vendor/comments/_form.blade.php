    ...
    <div class="card-body col-lg-6 mt-0">
        ...
        <form method="POST" action="{{ route('comments.store') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @if($errors->has('message')) is-invalid @endif" name="message" rows="3" height="100px" style="resize:none;" ></textarea>
            </div>
